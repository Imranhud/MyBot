...
return(
    ...
    <div>
        <div>
            ...
            <p className='text-center pb-3 text-dimWhite'>
                Tap, tap,tap! Can't stop, won't stop! <br /> Timer shows refill, but the fun won't flop!.
            </p>
            <div className='flex mt-4 items-start justify-evenly font-poppins'>
            ...
            <div className='flex items-start cursor-pointer justify-center my-8'>
            ...
            <div className='flex bg-slate-400 opacity-75 mx-auto max-w-[490px] mt-3 space-y-0 absolute bottom-0 w-full items-start justify-evenly font-poppins'>
                <div className='p-2 font-bold hover:bg-violet-700 hover:text-dimWhite hover:-translate-y-3 transition duration-500 w-[85px] text-center'>Tap</div>
